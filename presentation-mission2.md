...
## 01_data_prep.R
- adapt code to
- subset dates between date_start and date_end
- subset sars and pmmv data based on labProtocolID used between date_start and date_end ("SC_COV_4.1", "UA_COV_4.0", "SC_PMMV_2.1", "UA_PMMV_2.0")
...
- remove outlier based on quality variable. Set samples with "Quality concerns" to NA
